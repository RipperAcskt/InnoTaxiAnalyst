...
// Source: github.com/RipperAcskt/innotaxianalyst/internal/service (interfaces: DriverService)
...
func (m *MockDriverService) SetRating(arg0 context.Context, arg1 *proto.Rating) (*proto.Empty, error) {
	m.ctrl.T.Helper()
